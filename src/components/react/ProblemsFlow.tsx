    ...
    return (
        ...
        >
            ...
            <img
                ...
                loading="lazy"
                decoding="async"
                className="problem-mascot pointer-events-none absolute z-[1] select-none object-contain left-[-14%] bottom-[-10%] h-[38svh] w-auto opacity-90 drop-shadow-[0_25px_50px_rgba(168,85,247,0.55)] sm:left-[-10%] sm:h-[44svh] md:left-[-6%] md:bottom-[-4%] md:h-[54svh] lg:left-[-3%] lg:bottom-[-6%] lg:h-[55svh] lg:opacity-95 xl:left-[1%] xl:bottom-[-3%] xl:h-[60svh]"
            />
